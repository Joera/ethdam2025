...
export declare namespace TypeDefinitions {
  ...
  export type TrustMarkerStruct = {
    previous: AddressLike;
    expiry: BigNumberish;
  };

  export type TrustMarkerStructOutput = [previous: string, expiry: bigint] & {
    previous: string;
    expiry: bigint;
  };
}
...
export interface IHub extends BaseContract {
  ...
  treasuries: TypedContractMethod<[arg0: AddressLike], [string], "nonpayable">;
  ...
  trustMarkers: TypedContractMethod<
    ...
    [TypeDefinitions.TrustMarkerStructOutput],
    "nonpayable"
  >;
